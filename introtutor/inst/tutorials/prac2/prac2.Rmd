...
Replace the blanks in  the following code to limit the number of rows printed to 5:

```{r abundance, exercise=TRUE, exercise.eval=TRUE, exercise.blanks="___+"}
dhat <- ___
area <- ___
est.num.nests <- ___
print(est.num.nests)
...
```{r dendiff, exercise=TRUE, exercise.eval=TRUE, exercise.blanks="___+"}
smallest_est <- ___
largest_est <- ___
